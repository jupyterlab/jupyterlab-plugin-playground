...
It also adds a left sidebar tab, `Playground Tokens`, listing token string IDs you can use in plugin `requires` and `optional` arrays, with search and copy actions.
